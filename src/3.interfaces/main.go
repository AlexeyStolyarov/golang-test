// Теперь, любой тип данных, для которого будут определены методы
// Find() с вышеприведенной сигнатурой — автоматически будут удовлетворять интерфейс Finder.
// Duck typing — если плавает, как утка, выглядит, как утка, и крякает, как утка — то это утка.
package main
